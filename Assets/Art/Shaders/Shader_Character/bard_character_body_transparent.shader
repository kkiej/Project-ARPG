 ...
 *                                                                                             *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - */
shader "bard/role/body(transparent)"
{
    properties 
    {
        //Texture Settings 
    	...
    	_First_Fresnel_Shadow_Feather("First Fresnel Shadow Feather",Range(0.001,1)) = 0.5
    	...
    	_Second_Fresnel_Shadow_Feather("First Fresnel Shadow Feather",Range(0.001,1)) = 0.5
    	...
    	_Fresnel_Light_Feather("Fresnel Light Feather",Range(0.001,1)) = 0.5
