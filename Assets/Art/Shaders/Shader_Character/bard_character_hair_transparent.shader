...
//-----------------------writer:zh 2020/8/24--------------------
//--------------------------------------------------------------
Shader "bard/role/hair(transparent)"
{ 
    Properties
    {
        //Texture Settings 
    	...
    	_SSRimScale("SS Rim Scale",Range(0,1)) = 0.5
    	...
    	//视差
        [Sub(g5)]_Height("Height",Range(-1,1)) = -0.07
        [Sub(g5)]_ParallaxScale("Parallax Scale",Range(0,1)) = 0.075
	...
	CustomEditor "BardToonHairShaderGUI"
}
