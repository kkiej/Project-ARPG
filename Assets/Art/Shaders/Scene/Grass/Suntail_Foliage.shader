	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 Smoothness734 = saturate( float3(0,0,0) );
				
				float OpacityMask263 = tex2DNode1.a;
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( IndirectLight612 + DirectLight614 + Translucency631 + float4( Smoothness734 , 0.0 ) ).rgb;
...
WireConnection;765;2;452;0
WireConnection;765;3;267;0
WireConnection;765;4;774;0
WireConnection;765;5;236;0
WireConnection;263;0;1;4
WireConnection;259;0;340;0
ASEEND*/
//CHKSM=BBF2016EFB74C606ADA68F212D87998A98C33057