Shader "Water"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			#include "Assets/Art/Shaders/Includes/StylizedWaterForURP.hlsl"
			...
			half4 frag (VertexOutput i) : SV_Target
			{
				...
				#if defined(_DBUFFER)
					ApplyDecalToBaseColor(i.positionCS, color.rgb);
				#endif
		...
		Pass
		{
			...
			#include "Assets/Stylized Water For URP/Shaders/Libraries/StylizedWaterForURP.hlsl"
