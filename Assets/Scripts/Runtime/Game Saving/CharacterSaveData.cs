...
namespace LZ
{
    ...
    public class CharacterSaveData
    {
        ...
        [Header("Dialogue")]
        //  IF YOU PLAN ON USING MANY NPCS IT WOULD BE WISE TO USE A SERIALIZABLE DICTIONARY HERE TO SAVE VALUES (ID AND STAGE #)
        //  FOR THE SAKE OF SIMPLICITY AND THE TUTORIAL I WILL SIMPLY USE INT VALUES PER INDIVIDUAL CHARACTER
