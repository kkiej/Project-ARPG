...
{
    private static int numClusterX = 16;
    private static int numClusterY = 16;
    private static int numClusterZ = 16;
    private static int maxNumLights = 1024;
    private static int maxNumLightsPerCluster = 128;
    ...
    static int SIZE_OF_CLUSTERBOX = 8 * 3 * 4;
    struct ClusterBox
    {
    ...
    private ComputeBuffer clusterBuffer;     // 簇列表
    private ComputeBuffer lightBuffer;       // 光源列表
    private ComputeBuffer lightAssignBuffer; // 光源分配结果
    private ComputeBuffer assignTable;       // 光源分配索引表
    ...
    public ClusterLight()
    {
        ...
        clusterBuffer = new ComputeBuffer(numClusters, SIZE_OF_CLUSTERBOX);
    ...
    public void UpdateLightBuffer(VisibleLight[] lights)
    {
        ...
        for(int i=0; i<lights.Length; i++)
        {
            ...
            PointLight pl;
            var color = vl.color;
            pl.color = new Vector3(color.r, color.g, color.b);
